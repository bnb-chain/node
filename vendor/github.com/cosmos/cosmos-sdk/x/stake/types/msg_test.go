...
func TestMsgCreateValidator(t *testing.T) {
	commission1 := NewCommissionMsg(sdk.NewDecWithPrec(1, 2), sdk.NewDecWithPrec(1, 2), sdk.NewDecWithPrec(1, 2))
	commission2 := NewCommissionMsg(sdk.NewDecWithPrec(5, 2), sdk.NewDecWithPrec(5, 2), sdk.NewDecWithPrec(5, 2))
