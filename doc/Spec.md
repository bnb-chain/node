...
- [Binance DEX Specification](#binance-dex-specification)
    ...
    - [Base Components](#base-components)
        ...
        - [Client - Account and Balance Management](#client---account-and-balance-management)
        - [Client - Connection Bootstrap](#client---connection-bootstrap)
            - [Account Authetication](#account-authetication)
            - [Connection Authetication](#connection-authetication)
        - [Client - Market Data Display](#client---market-data-display)
        - [Client - API](#client---api)
    - [Periphery](#periphery)
        - [The Running Platform Spec](#the-running-platform-spec)
        - [Explorer](#explorer)
