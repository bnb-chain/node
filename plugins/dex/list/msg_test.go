...
func TestIdenticalBaseAssetAndQuoteAsset(t *testing.T) {
	msg := types.NewListMsg(sdk.AccAddress{}, 1, "BTC-000", "BTC-000", 1000)
...
func TestWrongBaseAssetSymbol(t *testing.T) {
	msg := types.NewListMsg(sdk.AccAddress{}, 1, "BTC", "BTC-000", 1000)
	err := msg.ValidateBasic()
	require.NotNil(t, err, "msg should be error")
...
func TestWrongQuoteAssetSymbol(t *testing.T) {
	msg := types.NewListMsg(sdk.AccAddress{}, 1, "BTC-000", "ETH", 1000)
	err := msg.ValidateBasic()
	require.NotNil(t, err, "msg should be error")
...
func TestWrongInitPrice(t *testing.T) {
	msg := types.NewListMsg(sdk.AccAddress{}, 1, "BTC-000", "BNB", -1000)
	err := msg.ValidateBasic()
	require.NotNil(t, err, "msg should be error")
