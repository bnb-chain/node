...
func TestKeeper_ExpireOrders(t *testing.T) {
	...
	keeper.AddOrder(NewNewOrderMsg(addr, "1", Side.BUY, "ABC_BNB", 1e6, 1e8), 10000, 10000)
	keeper.AddOrder(NewNewOrderMsg(addr, "2", Side.BUY, "ABC_BNB", 2e6, 2e8), 10000, 10000)
	keeper.AddOrder(NewNewOrderMsg(addr, "3", Side.BUY, "XYZ_BNB", 1e6, 1e8), 10000, 10000)
	keeper.AddOrder(NewNewOrderMsg(addr, "4", Side.SELL, "ABC_BNB", 1e6, 1e8), 10000, 10000)
	keeper.AddOrder(NewNewOrderMsg(addr, "5", Side.SELL, "ABC_BNB", 2e6, 2e8), 15000, 15000)
	keeper.AddOrder(NewNewOrderMsg(addr, "6", Side.BUY, "XYZ_BNB", 2e6, 2e8), 20000, 20000)
