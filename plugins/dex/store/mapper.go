...
type TradingPairMapper interface {
	AddTradingPair(ctx cmntypes.Context, pair types.TradingPair) error
	Exists(ctx cmntypes.Context, tradeAsset, quoteAsset string) bool
	GetTradingPair(ctx cmntypes.Context, tradeAsset, quoteAsset string) (types.TradingPair, error)
	ListAllTradingPairs(ctx cmntypes.Context) []types.TradingPair
	UpdateTickSizeAndLotSize(ctx cmntypes.Context, pair types.TradingPair, price int64) (tickSize, lotSize int64)
}
...
func (m mapper) AddTradingPair(ctx cmntypes.Context, pair types.TradingPair) error {
...
func (m mapper) Exists(ctx cmntypes.Context, tradeAsset, quoteAsset string) bool {
	store := ctx.KVStore(m.key)
...
func (m mapper) GetTradingPair(ctx cmntypes.Context, tradeAsset, quoteAsset string) (types.TradingPair, error) {
	store := ctx.KVStore(m.key)
	symbol := utils.Ccy2TradeSymbol(tradeAsset, quoteAsset)
...
func (m mapper) ListAllTradingPairs(ctx cmntypes.Context) (res []types.TradingPair) {
	store := ctx.KVStore(m.key)
...
func (m mapper) UpdateTickSizeAndLotSize(ctx cmntypes.Context, pair types.TradingPair, price int64) (tickSize, lotSize int64) {
