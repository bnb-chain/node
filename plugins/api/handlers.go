...
func (s *server) handleQuerySwapsByRecipientReq(cdc *wire.Codec, ctx context.CLIContext) http.HandlerFunc {
	return tksapi.QuerySwapsByRecipientReqHandler(cdc, ctx)
}
