...
func TestKeeper_IOCExpireWithFee(t *testing.T) {
	...
	assert.Equal("10000BNB", feeHolderCache[string(buyer.Bytes())].String())
}
...
func Test_IOCPartialExpire(t *testing.T) {
	...
	assert.Equal("50000BNB", feeHolderCache[string(buyer.Bytes())].String())
	assert.Equal("50000BNB", feeHolderCache[string(seller.Bytes())].String())
}
...
func Test_OneBuyVsTwoSell(t *testing.T) {
	...
	assert.Equal("150000BNB", feeHolderCache[string(buyer.Bytes())].String())
	assert.Equal("150000BNB", feeHolderCache[string(seller.Bytes())].String())
}
