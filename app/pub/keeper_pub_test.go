...
func TestKeeper_IOCExpireWithFee(t *testing.T) {
	...
	assert.Equal("BNB:10000", feeHolderCache[string(buyer.Bytes())].String())
}
...
func Test_IOCPartialExpire(t *testing.T) {
	...
	assert.Equal("BNB:50000", feeHolderCache[string(buyer.Bytes())].String())
	assert.Equal("BNB:50000", feeHolderCache[string(seller.Bytes())].String())
}
...
func Test_OneBuyVsTwoSell(t *testing.T) {
	...
	assert.Equal("BNB:150000", feeHolderCache[string(buyer.Bytes())].String())
	assert.Equal("BNB:150000", feeHolderCache[string(seller.Bytes())].String())
}
