...
func SetupTest(initPrices ...int64) (crypto.Address, sdk.Context, []sdk.Account) {
	...
	testApp.DexKeeper.FeeManager.UpdateConfig(feeConfig)
	coins := sdk.Coins{
...
// for common block
func UpdateContext(addr crypto.Address, ctx sdk.Context, height int64) sdk.Context {
...
// for breath block
func UpdateContext2(addr crypto.Address, ctx sdk.Context, height int64, tNow time.Time) sdk.Context {
