...
func Test_Expire_1(t *testing.T) {
	...
	ctx = UpdateContext2(addr, ctx, 2, tNow)

	testClient.cl.EndBlockSync(abci.RequestEndBlock{})

	ctx = UpdateContext2(addr, ctx, 3, tNow.AddDate(0, 0, 3))
	...
	ctx = UpdateContext2(addr, ctx, 5, tNow)

	testClient.cl.EndBlockSync(abci.RequestEndBlock{})

	ctx = UpdateContext2(addr, ctx, 6, tNow.AddDate(0, 0, 3))
...
func Test_Expire_5(t *testing.T) {
	...
	ctx = UpdateContext2(addr, ctx, 1, tNow)
