...
func Test_handleNewOrder_CheckTx(t *testing.T) {
	...
	testApp.DexKeeper.GetTradingPairMapper().AddTradingPair(ctx, types.NewTradingPair("BTC", "BNB", 1e8))
...
func Test_Match(t *testing.T) {
	...
	InitAccounts(ctx, testApp)
	testApp.DexKeeper.ClearOrderBook("BTC_BNB")
	testApp.DexKeeper.GetTradingPairMapper().AddTradingPair(ctx, types.NewTradingPair("ETH", "BNB", 1e8))
	testApp.DexKeeper.GetTradingPairMapper().AddTradingPair(ctx, types.NewTradingPair("btc", "BNB", 1e8))
