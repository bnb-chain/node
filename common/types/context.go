...
func NewContext(ms sdk.MultiStore, header abci.Header, isCheckTx bool, logger log.Logger) Context {
	c := Context{
...
func (c Context) KVStore(key sdk.StoreKey) sdk.KVStore {
	return c.multiStore().GetKVStore(key)
}

// TransientStore fetches a TransientStore from the MultiStore.
func (c Context) TransientStore(key sdk.StoreKey) sdk.KVStore {
	return c.multiStore().GetKVStore(key)
}
...
func (c Context) WithCacheWrapper(key interface{}, value sdk.CacheWrapper) Context {
	return c.withValue(key, value)
}
...
func (c Context) multiStore() sdk.MultiStore {
	return c.Value(contextKeyMultiStore).(sdk.MultiStore)
}
...
func (c Context) WithMultiStore(ms sdk.MultiStore) Context {
